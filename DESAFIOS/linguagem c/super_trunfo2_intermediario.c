...
printf("# OPÇÃO  - 2 - Área                      #\n");
printf("# OPÇÃO  - 3 - PIB                          #\n");
printf("# OPÇÃO  - 4 - Números de pontos Turísticos #\n");
printf("# OPÇÃO  - 5 - Densidade Pupolacional       #\n");
printf("# OPÇÃO  - 6 - Pib Per Capita               #\n");
printf("# OPÇÂO  - 7 - SUPER PODER                  #\n");
printf("#                                           #\n");
printf("#############################################\n\n\n");
...
case 1:
    ...
    break;
            case 5:
    if (densid_pop > densid_pop2){
        printf("Carta 1 - VENCEU!!!\n\n");
    }else if (densid_pop < densid_pop2){
        printf("Carta 2 - VENCEU!!!\n\n");
    }else {
        printf("Houve um empate!!!!\n\n");
    }
